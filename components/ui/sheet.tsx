...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute border-none right-8 top-8 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary">
        <X className="size-4" />
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 text-start py-6",
      className
    )}
    {...props}
  />
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex items-center justify-start sm:space-x-2 py-6",
      className
    )}
    {...props}
  />
